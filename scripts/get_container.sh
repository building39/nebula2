...
curl -u"administrator:test;realm=system_domain" -H "x-cdmi-specification-version: 1.1"  -H "Accept: application/cdmi-container" -X GET "http://cloud.fuzzcat.net:8080/cdmi/new_container5/" -v |python -m json.tool
